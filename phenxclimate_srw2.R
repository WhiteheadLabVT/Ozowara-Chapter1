...
#SRW: changed Orchard.num to orchard.num throughout this section

#SRW: See notes above about transformation, these models do look better but I
...
plot(TotalPhentrans ~ orchard.type, data=d.se)
...
#SRW: I am not getting the same numbers...
...
#SRW: Hmnnn, I think I have usually used Bray-curtis distance metrics, should
#read more about this. If you use advice like that from a forum it is helpful to
#link to the resource in your code
